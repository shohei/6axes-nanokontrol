module.exports = function(){
  ...
  var MySolver = ffi.Library('./lib/mysolver', {
  ...
  function calculationAndSend(i,type,port){
    if(type==='tilt'){
  ...
  return {
    turn : function(port){
      for(var i=0;i<361;i=i+60){
        setTimeout(function() { calculationAndSend(i,'turn',port); }, i*15);
      }

    },
    tilt : function(port){
      for(var i=0;i<361;i=i+60){
        setTimeout(function() { calculationAndSend(i,'tilt',port); }, i*15);
      }
    }
  }
}
